...
public class ExplosivePumpkinRenderer extends EntityRenderer<ExplosivePumpkinEntity> {
    ...
    public ExplosivePumpkinRenderer(EntityRendererManager renderManagerIn) {
        super(renderManagerIn);
        this.shadowSize = 0.5F;
    }

    @Override
    public void render(ExplosivePumpkinEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
        matrixStackIn.push();
